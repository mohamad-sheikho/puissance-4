                ...
                <div class="container-fieldset">
                        ...
                        <h1 class="connexion" >Connectez-vous</h1>
                            <fieldset class="left">
                                ...
                                <label for ="loginC">Pseudo   :</label>
                                <input id="loginC" type="text" name="loginC" placeholder="ex: abdel" />
                                <br>
                    ...
                    <div class="container-fieldset">
                        ...
                        <fieldset class="right">
                                ...
                                <label for ="loginR">Pseudo :</label>
                                <input id="loginR" type="text" name="loginR" placeholder="ex: abdel" />
                                <br>
